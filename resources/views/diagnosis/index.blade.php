        ...
        <div id="test-result-modal" data-modal-target="test-result-modal" tabindex="-1"
            ...
            <div class="relative w-full max-w-lg max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    <button type="button"
                        class="close-result-modal absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            $(document).ready(() => {
                ...
                const hideModal = (modalName) => {
                    switch (modalName) {
                        case "resultModal":
                            trModalElement.classList.add('-translate-y-full');
                            trModalElement.classList.add('opacity-0');
                            setTimeout(() => {
                                resultModal.hide();
                            }, 300);
                            break;
                        case "instructionModal":
                            instructionModalElement.classList.add('-translate-y-full');
                            instructionModalElement.classList.add('opacity-0');
                            setTimeout(() => {
